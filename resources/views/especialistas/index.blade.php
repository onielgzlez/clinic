    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">PERSONAL MEDICO
                    <div class="text-muted pt-2 font-size-sm">Listado de Especialistas</div>
                </h3>
            </div>
        ...
        <div class="card-body">
            <!--begin: Search Form-->
            <!--begin::Search Form-->
            <form action="{{ route('especialistas.index') }}" name="especialistas" id="formAdd" method="POST"
            ...
            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                <thead>
                <tr>
                    <th title="Field #1" tyle="width:50px;">Nombre y Apellidos</th>
                    <th title="Field #2">Cedula</th>
                    <th title="Field #4">Area</th> 
                    <th title="Field #3">Celular/E-Mail</th>                                                          
