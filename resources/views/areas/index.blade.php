...
<div class="card card-custom gutter-b">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">{{ __('locale.Specialty management') }}
                <span class="d-block text-muted pt-2 font-size-sm">{{ __('locale.Simplified specialty management') }}</span>
            </h3>
        </div>
        <div class="card-toolbar"><a href="{{ route('areas.create') }}" class="btn btn-primary font-weight-bolder">
                {{ Metronic::getSVG("media/svg/icons/Design/Flatten.svg", "svg-icon-md") }}
                {{ __('locale.Create specialty') }}</a>
        </div>
    </div>
    <div class="card-body">
