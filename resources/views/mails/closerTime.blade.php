                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    Cita cerca de comenzar!</h1>
                                <p style="margin:0;">En 30 minutos tienes una cita con {{ $appointment->patient->fullName }}, fecha {{ $appointment->init }}.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:0;font-size:24px;line-height:28px;font-weight:bold;">
                                <a href="{{ route('dashboard') }}" style="text-decoration:none;"><img
                                        src="{{ asset('imgs/doctor-g1b60fada7_1920.jpg') }}" width="600" alt=""
