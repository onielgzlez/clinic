          ...
          <![endif]-->
                        ...
                        <tr>
                            <td style="padding:40px 30px 30px 30px;text-align:center;font-size:24px;font-weight:bold;">
                                <a href="http://www.example.com/" style="text-decoration:none;"><img
                                        src="https://assets.codepen.io/210284/logo.png" width="165" alt="Logo"
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                <p style="margin:0;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In tempus
                                    adipiscing felis, sit amet blandit ipsum volutpat sed. Morbi porttitor, <a
                                        href="http://www.example.com/"
                                        style="color:#e50d70;text-decoration:underline;">eget accumsan dictum</a>, nisi
                ...
                <![endif]-->
                                <div class="col-lge"
                                    ...
                                    <p style="margin-top:0;margin-bottom:12px;">Nullam mollis sapien vel cursus
                                    ...
                                    <p style="margin-top:0;margin-bottom:18px;">Nam non ante risus. Vestibulum vitae
                                    ...
                                    <p style="margin:0;"><a href="https://example.com/"
                                            ...
                                            <!--[if mso]><i style="letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt">&nbsp;</i><![endif]--><span
                                                style="mso-text-raise:10pt;font-weight:bold;">Claim yours now</span>
                ...
                <![endif]-->
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin:0;font-size:14px;line-height:20px;">&reg; Someone, Somewhere 2021<br><a
                                        class="unsub" href="http://www.example.com/"
                                        style="color:#cccccc;text-decoration:underline;">Unsubscribe instantly</a></p>
                            </td>
                        </tr>
                    </table>
                    <!--[if mso]>
