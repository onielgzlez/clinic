                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    Su cita esta cerca de comenzar!</h1>
                                <p style="margin:0;">Su cita en la clínica {{ $appointment->organization->name }}, con fecha {{ $appointment->init }} comenzará en 30 minutos.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:0;font-size:24px;line-height:28px;font-weight:bold;">
                                <a href="{{ route('dashboard') }}" style="text-decoration:none;"><img
                                        src="{{ asset('imgs/pexels-karolina-grabowska-7195186.jpg') }}" width="600" alt=""
