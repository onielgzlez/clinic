                        ...
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                <h1
                                    ...
                                    Cita actualizada!</h1>
                                <p style="margin:0;">Le ha agendado una cita a {{ $appointment->patient->fullName }}, con fecha {{ $appointment->init }}.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding:0;font-size:24px;line-height:28px;font-weight:bold;">
                                <a href="{{ route('dashboard') }}" style="text-decoration:none;"><img
                                        src="{{ asset('imgs/doctor-gef7ad7c7a_1920.jpg') }}" width="600" alt=""
