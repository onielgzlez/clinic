<?php return [
    ...
    "Go home" => "Ir a inicio",
    "Go to" => "Ir a",
    "Go to page" => "Ir a la página :page",
    "Great! You have accepted the invitation to join the team." => "¡Genial! Usted ha aceptado la invitación para unirse al equipo :team.",
    "Greece" => "Grecia",
    ...
    "The attribute must be at least length characters and contain at least one number." => "El :attribute debe tener al menos :length caracteres y contener por lo menos un número.",
    "The attribute must be at least length characters and contain at least one special character and one number." => "El :attribute debe tener al menos :length caracteres y contener por lo menos un caracter especial y un número.",
    "The attribute must be at least length characters and contain at least one special character." => "El :attribute debe tener al menos :length caracteres y contener por lo menos un carácter especial.",
    "The attribute must be at least length characters and contain at least one uppercase character and one number." => "El :attribute debe tener al menos :length caracteres y contener por lo menos una letra mayúscula y un número.",
    "The attribute must be at least length characters and contain at least one uppercase character and one special character." => "El :attribute debe tener al menos :length caracteres y contener por lo menos una letra mayúscula y un carácter especial.",
    "The attribute must be at least length characters and contain at least one uppercase character, one number, and one special character." => "El :attribute debe tener al menos :length caracteres y contener por lo menos una letra mayúscula, un número y un carácter especial.",
    "The attribute must be at least length characters and contain at least one uppercase character." => "El :attribute debe tener al menos :length caracteres y contener por lo menos una letra mayúscula.",
    ...
    "The given attribute has appeared in a data leak. Please choose a different :attribute." => "El :attribute proporcionada se ha visto comprometida en una filtración de datos (data leak). Elija una :attribute diferente.",
    ...
    "Data" => "Datos",
    "Review and sent" => "Revisar y enviar",
    "Profile details" => "Detalles de perfil",
    "Change photo" => "Cambiar foto",
    "New specialty" => "Nueva especialidad",
    "Create specialty" => "Crear especialidad",
    ...
    "Simplified users management" => "Gestión de usuarios simplificada",
    "Specialty management" => "Gestión de especialidades",
    "Simplified specialty management" => "Gestión de especialidades simplificada",
    "The item was created successfully" => "El elemento fué creado satisfactoriamente.",
    "The item was updated successfully" => "El elemento fué actualizado satisfactoriamente.",
    "The item was deleted successfully" => "El elemento fué actualizado satisfactoriamente.",
    "The selected items have been deleted successfully" => "Los elementos seleccionados fueron eliminados correctamente.",
    "Sorry, looks like there are some errors detected, please try again" => "Lo sentimos, parece que se han detectado algunos errores. Vuelve a intentarlo.",
    "Ok, got it!" => "¡Ok, lo tengo!",
    "Your form has not been submitted!" => "¡Tu formulario no ha sido enviado!",
    "All is good! Please confirm the form submission" => "¡Todo bien! Confirme el envío del formulario",
    "Yes, submit!" => "¡Sí, enviar!",
    "Yes, delete!" => "¡Sí, eliminar!",
    "No, cancel" => "No, cancelar",
    "Setup your current location" => "Configura tu ubicación actual",
    "Please enter your address" => "Por favor ingrese su dirección.",
    "Contact Information Emergency" => "Contacto en caso de emergencia",
    "Form is validated, savind in" => "Formulario válidado, guardando ...",
    "Please try again" => "Vuelve a intentarlo",
    "Validating" => "Validando ...",
    "You will not be able to reverse this action!" => "No podrás revertir esta acción!",
    "New patients" => "Nuevos pacientes",
    "New users" => "Nuevos users",
    "New clinics" => "Nuevas clinicas",
    "New finance" => "Nueva finanza",
    "Create finance" => "Crear finanza",
    "Edit finance" => "Editar finanza",
    "Finances" => "Finanzas",
    "Finances management" => "Gestión de finanzas",
    "Simplified finances management" => "Gestión de finanzas simplificada",
    "Patients management" => "Gestión de pacientes",
    "Simplified patients management" => "Gestión de pacientes simplificada",
    "Appointments management" => "Gestión de citas",
    "Simplified appointments management" => "Gestión de citas simplificada",
    ...
    "Select size" => "Seleccionar tamaño de página",
    "Info" => "Viendo {{start}} - {{end}} de {{total}} registros",
    "Patient not found"=> "No pudimos encontrar un paciente con la cedula :attr",
    "Try filling data"=> "Debes completar los datos",
    "Type document and click search to fill data" => "Escribe la cédula y haz click en buscar para completar datos del paciente.",
    "fields" => [
        ...
        "document" => "Cédula",
        "area_job" => "Área de trabajo",
        "classification" => "Clasificación",
        "locale" => "Idioma",
        "type" => "Tipo",
        "organization" => "Clínica",
        'address'               => 'Dirección',
        'address_job'               => 'Dirección trabajo',
        'age'                   => 'Edad',
        'amount'                   => 'Cantidad',
        'order'                   => 'Orden',
        'concepts'                   => 'Concepto',
        ...
        'phone'                 => 'Teléfono',
        'telephone'                 => 'Teléfono domicilio',
        'jobphone'                 => 'Teléfono trabajo',
        'phone_reference'                 => 'Teléfono referencia',
        'reference'                 => 'Contacto de referencia',
        'whatsapp'                 => 'Whatsapp',
        'whatsapp_reference'                 => 'Whatsapp referencia',
        'contact_via'                 => 'Donde nos conoció',
